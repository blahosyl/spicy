...
- [UX/UI](#ux-ui)
  ...
  * [Scope](#scope)
    + [Clearly separated fields for creating and viewing recipes](#clearly-separated-fields-for-creating-and-viewing-recipes)
    + [Searching and filtering](#searching-and-filtering)
    + [Alternative color themes](#alternative-color-themes)
    + [Planning and prioritization](#planning-and-prioritization)
  * [Structure](#structure)
    + [Data models](#data-models)
      - [Recipe model](#recipe-model)
      - [Ingredient & IngredientQuantity models](#ingredient---ingredientquantity-models)
        * [Quantity data type](#quantity-data-type)
        * [IngredientQuantity not compulsory](#ingredientquantity-not-compulsory)
        * [Instances of Ingredient cannot be duplicated](#instances-of-ingredient-cannot-be-duplicated)
        * [IngredientQuantities **can** be duplicated](#ingredientquantities---can---be-duplicated)
      - [Comment model](#comment-model)
      - [RecipeAttribute and Attribute models](#recipeattribute-and-attribute-models)
  ...
  * [Skeleton](#skeleton)
    ...
    + [Recipe detail wireframes](#recipe-detail-wireframes)
  * [Surface](#surface)
    ...
    + [UX Improvements](#ux-improvements)
      - [Meaningful navigation link names](#meaningful-navigation-link-names)
      - [Easier motor coordination](#easier-motor-coordination)
...
- [Features](#features)
  * [`collection` app](#-collection--app)
    ...
    + [User bar](#user-bar)
    + [Footer](#footer-1)
    + [Home page | recipe list](#home-page---recipe-list)
      - [Filtering](#filtering)
      - [Searching](#searching)
    + [Recipe detail page](#recipe-detail-page)
    + [Commenting](#commenting)
  * [`community` app](#-community--app)
    + [community page/profile list](#community-page-profile-list)
    + [Profile detail page](#profile-detail-page)
  * [Access management](#access-management-1)
  * [Admin Panel](#admin-panel)
    + [Default functionality](#default-functionality)
    + [Restricted access for Staff users](#restricted-access-for-staff-users)
...
- [Credits](#credits)
  ...
  * [Media](#media)
    + [Images](#images)
  * [Readmes](#readmes)
  * [Unsolicited pull request by an unknown person](#unsolicited-pull-request-by-an-unknown-person)
