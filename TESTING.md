...
- [Code validation](#code-validation)
  * [HTML validation](#html-validation)
    + [Home page validation](#home-page-validation)
    + [Home page paginated validation](#home-page-paginated-validation)
    + [Home page filtered validation](#home-page-filtered-validation)
    + [Home page filtered paginated validation](#home-page-filtered-paginated-validation)
    + [Home page filtered with no results validation](#home-page-filtered-with-no-results-validation)
    + [Search page validation](#search-page-validation)
    + [Search page with no results](#search-page-with-no-results)
    + [Search page with paginated link validation](#search-page-with-paginated-link-validation)
    + [Signup: known issue](#signup--known-issue)
    + [Signin validation](#signin-validation)
    + [Signout validation](#signout-validation)
    + [Confirm email validation](#confirm-email-validation)
    + [Community validation](#community-validation)
    + [Profile detail validation](#profile-detail-validation)
  * [CSS validation](#css-validation)
  * [JavaScript validation](#javascript-validation)
    + [`comments.js`: known issue](#-commentsjs---known-issue)
    + [`filter.js` validation](#-filterjs--validation)
    + [`themes.js` validation](#-themesjs--validation)
  * [Python validation](#python-validation)
    + [`collection` app Python validation](#-collection--app-python-validation)
      - [`admin.py`](#-adminpy-)
      - [`forms.py`](#-formspy-)
      - [`models.py`](#-modelspy-)
      ...
      - [`views.py`](#-viewspy-)
      - [`urls.py`](#-urlspy--1)
    + [`community` app Python validation](#-community--app-python-validation)
      - [`admin.py`](#-adminpy--1)
      - [`models.py`](#-modelspy--1)
      - [`views.py`](#-viewspy--1)
      - [`urls.py`](#-urlspy--2)
  * [Project-level Python validation](#project-level-python-validation)
      - [`settings.py`](#-settingspy-)
      - [`urls.py`](#-urlspy--3)
- [Manual feature testing](#manual-feature-testing)
  * [Collection/recipes manual testing](#collection-recipes-manual-testing)
    + [Navigation bar | desktop](#navigation-bar---desktop)
    + [Navigation bar | mobile](#navigation-bar---mobile)
    + [User bar | if user signed in](#user-bar---if-user-signed-in)
    + [User bar | if user not signed in](#user-bar---if-user-not-signed-in)
    + [Footer](#footer)
    + [Home page](#home-page)
    + [Recipe detail page](#recipe-detail-page)
    + [Search results page](#search-results-page)
    + [Pagination links](#pagination-links)
  * [Community manual testing](#community-manual-testing)
    + [Community page](#community-page)
    + [Profile detail page](#profile-detail-page)
  * [Authentication manual testing](#authentication-manual-testing)
    + [Signin page](#signin-page)
    + [Signout page](#signout-page)
    + [Signup page](#signup-page)
    + [Email sent page](#email-sent-page)
...
- [Accessibility testing](#accessibility-testing)
  ...
  * [Color contrasts](#color-contrasts)
    + [Color specifications](#color-specifications)
        * [Orange theme specifications](#orange-theme-specifications)
        * [Blue theme specifications](#blue-theme-specifications)
        * [Green theme specifications](#green-theme-specifications)
        * [Neutral color specifications](#neutral-color-specifications)
    + [Orange theme contrast check](#orange-theme-contrast-check)
    + [Blue theme contrast check](#blue-theme-contrast-check)
    + [Green theme contrast check](#green-theme-contrast-check)
